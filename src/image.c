...
#if 1
void _zbar_image_refcnt (zbar_image_t *img,
                                       int delta)
{
...
void _zbar_image_swap_symbols (zbar_image_t *a,
                                             zbar_image_t *b)
{
...
{
    zbar_image_cleanup_handler_t *cleanup = NULL;
    zbar_image_t *newimg = NULL;
    if(!img)
        return;
                      ...
                      const char *filebase)
{
    ...
    char filename[1024];//char filename[len];  yangliang
    int n = 0;
    zimg_hdr_t hdr;
    FILE *f = NULL;
    int rc = 0;
