...
int err_capture (const void *container,
                       errsev_t sev,
                       zbar_error_t type,
                       const char *func,
                       const char *detail)
...
int err_capture_str (const void *container,
                           errsev_t sev,
                           zbar_error_t type,
                           const char *func,
                           const char *detail,
...
int err_capture_int (const void *container,
                           errsev_t sev,
                           zbar_error_t type,
                           const char *func,
                           const char *detail,
...
int err_capture_num (const void *container,
                                   errsev_t sev,
                                   zbar_error_t type,
                                   const char *func,
                                   const char *detail,
