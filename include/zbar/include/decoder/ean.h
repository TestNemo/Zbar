...
extern void ean_new_scan (ean_decoder_t *ean);
extern void ean_reset (ean_decoder_t *ean);
extern unsigned ean_get_config (ean_decoder_t *ean,zbar_symbol_type_t sym);
...
extern zbar_symbol_type_t _zbar_decode_ean(zbar_decoder_t *dcode);
