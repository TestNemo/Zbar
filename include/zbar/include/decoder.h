...
#endif
//#if 1//    #ifdef ENABLE_PDF417  暂时修改，杨亮
#ifdef ENABLE_PDF417
...
#endif
#ifdef ENABLE_PDF417
//#if 1     //#ifdef ENABLE_PDF417       杨亮暂时修改
...
extern char get_color (const zbar_decoder_t *dcode);
extern unsigned get_width (const zbar_decoder_t *dcode,unsigned char offset);
extern unsigned pair_width (const zbar_decoder_t *dcode,unsigned char offset);
extern unsigned calc_s (const zbar_decoder_t *dcode,unsigned char offset, unsigned char n);
extern int decode_e (unsigned e,unsigned s,unsigned n);
extern char get_lock (zbar_decoder_t *dcode,zbar_symbol_type_t req);
extern char size_buf (zbar_decoder_t *dcode,unsigned len);
