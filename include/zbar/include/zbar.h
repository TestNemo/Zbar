 ...
 */
extern const char *zbar_get_symbol_name(zbar_symbol_type_t sym);//symbol.c
 ...
 */
extern const char *zbar_get_addon_name(zbar_symbol_type_t sym);//symbol.c
...
extern int _zbar_error_spew(const void *object,
                            int verbosity);//error.c
extern const char *_zbar_error_string(const void *object,
                                      int verbosity);//error.c
									  
extern zbar_error_t _zbar_get_error_code(const void *object);//error.c
 ...
 */
extern zbar_symbol_type_t zbar_symbol_get_type(const zbar_symbol_t *symbol);//symbol.c

/** retrieve data decoded from symbol.
 * @returns the data string
 */
extern const char *zbar_symbol_get_data(const zbar_symbol_t *symbol);//symbol.c

/** retrieve length of binary data.
 * @returns the length of the decoded data
 */
extern unsigned int zbar_symbol_get_data_length(const zbar_symbol_t *symbol);//symbol.c
 ...
 * @since 0.9
 */
extern int zbar_symbol_get_quality(const zbar_symbol_t *symbol);//symbol.c
 ...
 */
extern int zbar_symbol_get_count(const zbar_symbol_t *symbol);//symbol.c
 ...
 */
extern unsigned zbar_symbol_get_loc_size(const zbar_symbol_t *symbol);//symbol.c
 ...
 */
extern const zbar_symbol_t *zbar_symbol_next(const zbar_symbol_t *symbol);//symbol.c
...
zbar_symbol_get_components(const zbar_symbol_t *symbol);//symbol.c
...
zbar_symbol_first_component(const zbar_symbol_t *symbol);//symbol.c
 ...
 * @since 0.10
 */
extern int zbar_symbol_set_get_size(const zbar_symbol_set_t *symbols);//symbol.c
 ...
 */
extern const zbar_symbol_t*
zbar_symbol_set_first_symbol(const zbar_symbol_set_t *symbols);//symbol.c
 ...
 */
extern zbar_image_t *zbar_image_create(void);//Image.c
 ...
 */
extern void zbar_image_destroy(zbar_image_t *image);//Image.c
...
extern zbar_image_t *zbar_image_convert(const zbar_image_t *image,
                                        unsigned long format);//convert.c
...
extern int zbar_image_write(const zbar_image_t *image,
                            const char *filebase);//Image.c

/** read back an image in the format written by zbar_image_write()
 * @note TBD
 */
extern zbar_image_t *zbar_image_read(char *filename);//No Realize.
...
extern zbar_symbol_type_t zbar_scan_y(zbar_scanner_t *scanner,
                                      int y);
/*extern zbar_symbol_type_t zbar_scan_rgb24 (zbar_scanner_t *scanner,
                                                    unsigned char *rgb);*/
